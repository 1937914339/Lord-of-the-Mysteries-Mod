...
public class BlackSpottedFrogEntity extends PathfinderMob implements GeoEntity {
    ...
    public BlackSpottedFrogEntity(EntityType<? extends PathfinderMob> type, Level level) {
