...
/**
 * 人皮影实体（灵体，仅灵视可见的飘浮鬼影，GeckoLib 动画实体）。
 * <p>
 * 敌对近战怪物，如鬼魂般在空中飘浮游荡并追击玩家：无重力 + 飞行移动控制
 * + 飞行寻路（参考 {@link WraithEntity}）。
 * <p>
 * 体型：0.6 × 1.9（宽 × 高）；生命 20，移速 0.2，攻击力 5。
 * <p>
 * 动画：{@code animation.idle} 待机 / {@code animation.walk} 移动 / {@code animation.attack} 攻击。
 */
public class HumanSkinShadowEntity extends Monster implements GeoEntity, SpiritBeing {
    ...
    public HumanSkinShadowEntity(EntityType<? extends Monster> type, Level level) {
        super(type, level);
