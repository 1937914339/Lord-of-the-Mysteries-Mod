...
/**
 * 恶豹实体（GeckoLib 动画敌对生物）。
 * <p>
 * 身形矫健的四足野兽，快速奔袭并扑咬玩家。
 * <p>
 * 体型：0.9 × 0.9（宽 × 高）；生命 25，移速 0.4，攻击力 6。
 * <p>
 * 动画：{@code animation.idle} 待机 / {@code animation.walk} 移动 / {@code animation.attack} 攻击。
 */
public class EvilPantherEntity extends Monster implements GeoEntity {
    ...
    public EvilPantherEntity(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
