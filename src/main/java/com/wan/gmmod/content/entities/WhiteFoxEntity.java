...
/**
 * 白狐狸实体（GeckoLib 动画中立生物）。
 * <p>
 * 温和的中立生物，不主动攻击玩家，仅待机与漫步。
 * <p>
 * 体型：0.6 × 0.8（宽 × 高）；生命 15，移速 0.35，攻击力 3（不主动攻击）。
 * <p>
 * 动画：{@code animation.idle} 待机 / {@code animation.walk} 移动。
 */
public class WhiteFoxEntity extends PathfinderMob implements GeoEntity {
    ...
    public WhiteFoxEntity(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
    }
