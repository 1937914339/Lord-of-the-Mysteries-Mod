...
/**
 * 深渊恶魔实体（GeckoLib 动画敌对生物）。
 * <p>
 * 自深渊爬出的巨大恶魔，拥有极高生命力，并以超远追踪距离猎杀猎物。
 * <p>
 * 体型：0.8 × 2.2（宽 × 高）；生命 80，移速 0.25，攻击力 8，追踪距离 32。
 * <p>
 * 动画：{@code animation.idle} 待机 / {@code animation.walk} 移动 / {@code animation.attack} 攻击。
 */
public class AbyssDemonEntity extends Monster implements GeoEntity {
    ...
    public AbyssDemonEntity(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
