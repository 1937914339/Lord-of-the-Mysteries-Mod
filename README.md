...
你是一名刚踏入非凡世界的「序列 9」新人。收集材料、研读配方、在炼药锅前熬煮属于你的魔药，沿着 22 条途径的阶梯一路晋升——但记住：**“一边融入角色，竭力扮演，一边抽离情感，淡然审视，并通过点滴对比，认清自身，找到最真实的自我”**。
  大家可以先体验模组内容，许多东西还未完成设定和获取方式，不建议在生存模式游玩。
- **22 条途径 × 10 个序列**：愚者、门、错误、完美者、倒吊人、太阳、暴君、白塔、空想家、死神、黑暗、黄昏巨人、红祭司、隐者、月亮、母亲、深渊、被缚者、魔女、审判者、黑皇帝、命运之轮——全部实装，每条途径 9→0 。（已完成所有途径中低序列，高序列还在开发）
...
### 魔药与配方卷轴
- 全部 ** 种序列魔药**通过**炼药锅**合成：纯水入锅 → 投入材料 → 木棍搅拌三次。
...
### 古代神秘物品
「有少许神秘力量的古代物品」系列——破碎的圣像手指、疯人院入院记录、焦灼的圣袍边角、血染的六便士等，每一件都藏着力量与代价。（还在继续添加物品）

## 🌍 世界（还在持续更新生物种类和世界生成）

- **30 +种神奇花草**以十字形态生成于主世界草地，是炼药的材料基础。（还在继续添加种类）
- **好运圃**：好运之花立于好运之花泥土之上，四叶草环绕生长——其中小概率藏着银色四叶草。
- **40+ 种生物**：怨灵、狼人、美人鱼、修女与神父、告死乌鸦、双形态的噩梦邪眼、银白战熊……每种都有专属材料掉落。（生物种类还在继续添加）
- **城市系统 **：结构与村庄改造。 还原城市，提供城市化玩法（还在开发）
**特定天气系统，雾霾 血月 （还在持续添加） 
 **22条途径主线任务 支线任务  特定任务 临时任务 （还在持续添加）
**灵摆和手杖等都用动画来丰富游玩效果
